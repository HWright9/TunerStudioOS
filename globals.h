...
const unsigned char ECU_signature[]    = "speeduino_TS_OS_V0.10_dev";       //this must match the ini
const unsigned char ECU_RevNum[]       = "TS_OS_V0.10_dev";      //this is what is displayed in the TS header bar
